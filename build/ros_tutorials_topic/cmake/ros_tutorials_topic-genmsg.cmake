...
set(MSG_I_FLAGS "-Iros_tutorials_topic:/home/dongha/me491_ros/src/ros_tutorials_topic/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/dongha/me491_ros/src/ros_tutorials_topic/msg/MsgTutorial.msg" NAME_WE)
add_custom_target(_ros_tutorials_topic_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tutorials_topic" "/home/dongha/me491_ros/src/ros_tutorials_topic/msg/MsgTutorial.msg" ""
)
...
_generate_msg_cpp(ros_tutorials_topic
  "/home/dongha/me491_ros/src/ros_tutorials_topic/msg/MsgTutorial.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_topic)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_topic\")")
  # install generated code
  install(
